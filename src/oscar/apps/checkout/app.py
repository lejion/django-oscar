    ...
    def get_urls(self):
        urls = [
            ...
            url(_(r'preview/$'),
                ...
                name='preview'),
            url(_(r'thank-you/$'), self.thankyou_view.as_view(),
                name='thank-you'),
        ]
