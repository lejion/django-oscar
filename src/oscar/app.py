...
class Shop(Application):
    ...
    def get_urls(self):
        urls = [
            url(_(r'^catalogue/'), include(self.catalogue_app.urls)),
            url(_(r'^basket/'), include(self.basket_app.urls)),
            ...
            url(_(r'^password-reset/confirm/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)/$'),
